...
#.........................................
server2Name = "163.143.11.43"
server2Port = 12001
destAddress2 = (server2Name, server2Port)
clientSocket2 = socket(AF_INET, SOCK_STREAM)
clientSocket2.connect(destAddress2)
...
def connectServer(clientSocket,sentence):
    ...
    print(f"Received message from IP {serverIP} and port {serverPort}")
...
while True:
    ...
    connectServer(clientSocket2, sentence)
